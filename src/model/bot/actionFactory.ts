    ...
    switch (actionResponse.next_action) {
      ...
      case "utter_give_name":
        return new GiveNameAction(
          botResources,actionResponse.tracker.slots.name);
      case "utter_no_name":
        return new NoNameAction(botResources);
      case "utter_give_number":
        return new GiveNumberAction(
          botResources,actionResponse.tracker.slots.number);
      case "utter_no_number":
        return new NoNumberAction(botResources);
